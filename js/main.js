...
//--------------------------------------------------------------------------
// refill locations
function appRefillLocations(tbl){
	jQuery('#listing_sub_location_id')[0].selectedIndex = 0;
...
//--------------------------------------------------------------------------
// change category pagination
function appPageCategory(page){
	jQuery('#frmCategoryView input[name=p]').val(page);
	jQuery('#frmCategoryView').submit();
}
