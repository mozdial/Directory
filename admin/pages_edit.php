...
if($objLogin->IsLoggedInAsAdmin() && $objLogin->HasPrivileges('edit_pages')){
	...
	draw_title_bar(prepare_breadcrumbs(array(_MENUS_AND_PAGES=>'',_PAGE_MANAGEMENT=>'', $page_link_name=>'')));
	echo $msg;
...
?>
    ...
    <script type="text/javascript">	
		...
		<?php if(Application::Get('page_id') != 'home' && Application::Get('type') != 'system') echo 'Calendar.setup({firstDay:0, inputField:\'frmPage_finish_publishing\', ifFormat:\'%Y-%m-%d\', showsTime:false, button:\'finish_publishing_icon\'});'; ?>
	</script>
