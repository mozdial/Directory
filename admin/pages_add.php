...
?>
	...
	<form name='frmPage' method='post'>
		...
		<tr>
			<td valign="top" style="border:1px solid #dedede">
				...
				<tr id="page_row_2">
					<td colspan="2">				
						<textarea name="page_text" id="my_page_text" rows="20" cols="80"><?php echo $objPage->GetText(); ?></textarea>
					</td>
				</tr>
			...
			<td valign="top" style="width:270px;border:1px solid #dedede">
				...
				<tr><td colspan="3" nowrap height="3px"></td></tr>
				<tr>
	...
	<script type="text/javascript">
		...
		Calendar.setup({firstDay:0, inputField:'frmPage_finish_publishing', ifFormat:'%Y-%m-%d', showsTime:false, button:'finish_publishing_icon'});		
	</script>	
