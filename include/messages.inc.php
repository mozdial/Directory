...
define("_ADSENSE_SETTINGS","AdSense Settings");
define("_ADVANCED","Advanced");
define("_ADVANCED_SEARCH","Advanced Search");
define("_ADVERTISE","Advertise");
define("_ADVERTISE_PLAN","Advertise Plan");
define("_ADVERTISE_PLANS","Advertise Plans");
define("_AFTERNOON","Afternoon");
...
define("_ALERT_REQUIRED_FILEDS","Items marked with an asterisk (<span class='required'>*</span>) are required");
define("_ALL","All");
define("_ALLOW","Allow");
define("_ALLOW_COMMENTS","Allow Comments");
define("_ALL_LOCATIONS","all locations");
define("_ALL_SUB_LOCATIONS","all sub locations");
...
define("_AVAILABLE_LISTINGS_ALERT","You have _LISTINGS_COUNT_ listings available for publishing.");
define("_AVAILABLE_LISTINGS_TOOLTIP","Displays a number of available listings for customer");
...
define("_BY_PHONE","By phone");
define("_BY_PHONE_OR_EMAIL","By phone or email");
...
define("_CATEGORIES_COUNT","Categories Count");
define("_CATEGORIES_MANAGEMENT","Categories Management");
define("_CATEGORY","Category");
define("_CATEGORY_DELETE_LISTINGS","You cannot delete this category, because it still includes some listings! Please remove all listings before this operation.");
...
define("_CONFIRMED_SUCCESS_MSG","Thank you for confirming your registration! <br>You may now log into your account. Click <a href='index.php?customer=login'>here</a> to proceed.");
...
define("_DASHBOARD_INQUIRIES_LINK","<p><b>&#8226;</b> <a href=index.php?customer=inquiries>Inquiries</a> page allows you to view received inquires and reply them.</p>");
define("_DASHBOARD_ORDERS_LINK","<p><b>&#8226;</b> <a href='index.php?customer=my_orders'>Orders</a> page allows you to manage your orders.</p>");
define("_DATE","Date");
...
define("_DESCRIBE_WHAT_YOU_NEED","<b>Describe here what you need</b> <br>NOTE! It is free and not binding");
define("_DESCRIPTION","Description");
define("_DIRECT","Direct");
define("_DIRECTORY_STATISTICS","Directory Statistics");
define("_DIRECT_INQUIRY_NOT_ALLOWED","According to the system settings you cannot send direct inquiry to this company/business!");
...
define("_HIDE","Hide");
define("_HOME","Home");
define("_HOME_PAGE_WELCOME_TEXT","<p>Welcome to Administrator Control Panel that allows you add, edit or delete site content. With this Administrator Control Panel you can easy manage users, orders and perform a full site management.</p>
...
define("_INCOMING_JOBS","Incoming Jobs");
define("_INQUIRIES","Inquiries");
define("_INQUIRIES_COUNT","Inquiries Count");
define("_INQUIRIES_MANAGEMENT","Inquiries Management");
define("_INQUIRIES_REPLIES","Inquiries Replies");
define("_INQUIRIES_SETTINGS","Inquiries Settings");
define("_INQUIRY_BUTTON","Inquiry Button");
define("_INQUIRY_DETAILS","Inquiry Details");
define("_INQUIRY_FORM_DISCLAIMER","Your personal information will be used only for the purposes stated above, will not be shared with third parties other than those described above and you can only retrieve reply out of _COUNT_ companies.");
define("_INQUIRY_SENT_SUCCESS_MSG","Thank you! Your inquiry has been successfully submitted. Please wait for at least few business days to receive a response to your inquiry. If you have any questions, please contact administration of the site.");
define("_INQUIRY_TO_YOURSELF_PROHIBITED","You cannot send inquiry to yourself!");
...
define("_INTEGRATION_MESSAGE","Copy the code below and put it in the appropriate place of your website to get an Inquiry Form.");
define("_INTEGRATION_TOP_MESSAGE","You may integrate Inquiry Form engine with another existing website.");
...
define("_INVOICE_SENT_SUCCESS","The invoice has been successfully sent to the client!");
...
define("_ITEMS","Items");
define("_I_AM_AVAILABLE","I am available");
define("_JANUARY","January");
define("_JULY","July");
define("_JUNE","June");
define("_KEY","Key");
define("_KEYWORDS","Keywords");
define("_KEYWORDS_COUNT","Keywords Count");
...
define("_LAST_7_DAYS","Last 7 days");
...
define("_LISTINGS","Listings");
define("_LISTINGS_AWAITING_MODERATION_ALERT","There are _COUNT_ listing/s awaiting your moderation. Click <a href='index.php?admin=mod_listings_management'>here</a> for review.");
define("_LISTINGS_COUNT","Listings Count");
define("_LISTINGS_MANAGEMENT","Listings Management");
define("_LISTINGS_PURCHASING","Listings Purchasing");
define("_LISTINGS_SETTINGS","Listings Settings");
define("_LISTING_MAX_CATEGORIES_ALERT","You have reached the maximum number of allowed categories for this listing (according to selected advertising plan).");
define("_LISTING_MAX_KEYWORDS_ALERT","The maximum allowed number of keywords is _MAX_! Please re-enter.");
...
define("_MAXIMUM_ALLOWED_INQUIRIES_PER_SESSION","You have reached the maximum number (_COUNT_) of allowed inquiries for this session. Please try again later.");
define("_MAX_CHARS","(max: _MAX_CHARS_ chars)");
define("_MAX_ORDERS_ERROR","You have reached the maximum number of permitted orders, that you have not yet finished! Please complete at least one of them to proceed purchasing of new listings.");
define("_MAY","May");
define("_MD_ADSENSE","This module provides web content providers with the means to earn revenue from blog visitors by displaying ads from Google AdSense™ advertising service.");
...
define("_MD_INQUIRIES","The Enquiries module allows visitors on your site to submit requests to businesses in specific category or directly to obtain from them the necessary information, get offers etc.");
define("_MD_LISTINGS","Listings module allows administrator to create and manage listings, listing categories etc.");
...
define("_MD_PAYMENTS","The module Payments allows you to easily accepts and manage payments for advertise of listings from your customers.");
define("_MD_RATINGS","The Ratings module allows your users to rate the listings. The number of votes and average rating will be shown at the appropriate listing.");
define("_MENUS","Menus");
...
define("_MS_ADD_WATERMARK","Specifies whether to add watermark to listing images or not");
define("_MS_ADMIN_CHANGE_USER_PASSWORD","Specifies whether to allow changing user password by Admin");
define("_MS_ADSENSE_CODE_ACTIVATION","Specifies which part of AdSense blocks is active");
define("_MS_ADSENSE_CODE_HORIZONTAL","Specifies a code for horizontal banner, that must be taken from advertising company");
define("_MS_ADSENSE_CODE_VERTICAL","Specifies a code for vertical banner, that must be taken from advertising company");
...
define("_MS_ALLOW_CUST_LOGIN","Specifies whether to allow customers to login to the site");
define("_MS_ALLOW_CUST_REGISTRATION","Specifies whether to allow customers to register");
define("_MS_ALLOW_CUST_RESET_PASSWORDS","Specifies whether to allow customers to restore their passwords");
define("_MS_ALLOW_DIRECT_INQUIRY","Specifies whether to allow visitors to send direct inquiries to businesses");
...
define("_MS_CATEGORIES_IMAGES","Specifies whether to show categories images or not");
define("_MS_COLUMNS_ON_PAGE","Specifies the number of columns in the table of categories");
...
define("_MS_CUSTOMERS_LOGIN_BLOCK","Specifies whether to show customers login block on homepage or not");
define("_MS_CUST_IMAGE_VERIFICATION","Specifies whether to allow image verification (captcha) on customer registration page");
...
define("_MS_KEEP_HISTORY_DAYS","The maximum number of days to keep the inquiries history");
define("_MS_LISTINGS_NAME_LENGTH","Defines a length of display listing name in a side block (in chars)");
define("_MS_LISTINGS_PER_PAGE","Specifies a maximum number of listings that could be displayed on page");
define("_MS_LIST_PRE_MODERATION_ALLOW","Specifies whether to allow pre-moderation for listings");
define("_MS_MAXIMUM_ALLOWED_ORDERS","Specifies the maximum number of allowed orders (not completed) per customer");
define("_MS_MAXIMUM_REPLIES","Specifies a maximum number of replies that visitor can retrieve for each inquiry");
define("_MS_MULTIPLE_CATEGORIES","Specifies whether to allow Multiple Categories for Listings: 1 - one category, 2 - two categories etc.");
...
define("_MS_RATINGS_USER_TYPE","Type of users, who can rate listings");
...
define("_MS_SHOW_CATEGORIES_HOME_BLOCK","Specifies whether to show Categories home block or not");
define("_MS_SHOW_CATEGORIES_SIDE_BLOCK","Specifies whether to show Categories side block or not");
define("_MS_SHOW_DIRECTORY_STATISTICS","Specifies whether to show Directory Statistics side block or not");
define("_MS_SHOW_EXPIRED_LISTINGS","Specifies whether to show expired listings until Cron Job close them or not");
define("_MS_SHOW_FEATURED_BLOCK","Specifies whether to show Featured Listings side block or not");
define("_MS_SHOW_INQUIRIES_BLOCK_BLOCK","Defines whether to show Last Inquiries side block or not");
...
define("_MS_SHOW_RECENT_BLOCK","Specifies whether to show Recent Listings side block or not");
define("_MS_SUB_CATEGORIES_COUNT","Specifies a  number of sub-categories for each category that could be displayed on home page");
...
define("_MY_LISTINGS","My Listings");
...
define("_NO_CATEGORIES_FOUND","No categories found!");
define("_NO_COMMENTS_YET","No comments yet.");
define("_NO_INCOMMING_JOBS_YET","No incoming jobs yet.");
define("_NO_LISTINGS_FOUND","No listings found in this category!");
define("_NO_LISTINGS_TO_DISPLAY","There are no listings to display.");
...
define("_NO_PAYMENT_METHODS_AVAILABLE","No payment methods available!");
define("_NO_RECORDS_FOUND","No records found");
define("_NO_RECORDS_UPDATED","No records were updated!");
define("_NO_SUBCATEGORIES","No sub-categories found!");
...
define("_PC_INQUIRY_REPLAY_DETAILS_TEXT","information about inquiry reply and customer");
define("_PC_LAST_NAME_TEXT","the last name of user or admin");
define("_PC_LISTING_DETAILS_TEXT","information about listing");
define("_PC_ORDER_DETAILS_TEXT","important information about the order, description of advertise plan etc.");
...
define("_PREFERRED_TO_BE_CONTACTED","I prefer to be contacted");
define("_PREPARING","Preparing");
define("_PREPAYMENT","Prepayment");
...
define("_RATING_BUTTON","Rating Button");
define("_REACTIVATION_EMAIL","Reactivation Email");
define("_READ_MORE","Read more");
define("_REASON","Reason");
define("_RECALCULATE_LISTING_COUNT","Recalculate Listings Count");
define("_RECENT_LISTINGS","Recent Listings");
define("_RED","Red");
...
define("_SELECT_PLAN","Select Advertise Plan");
define("_SEND","Send");
define("_SENDING","Sending");
define("_SEND_COPY_TO_ADMIN","Send a copy to admin");
define("_SEND_DIRECT_INQUIRY","Send Direct Inquiry");
define("_SEND_INQUIRY","Send Inquiry");
define("_SEND_INQUIRY_TO","Send Inquiry to");
...
define("_STEP","Step");
define("_STEP_1_DESCRIPTION","<b>Send an inquiry</b><br>Completely free, enter what you want help with and where.");
define("_STEP_2_DESCRIPTION","<b>Wait for quotes</b><br>Receive quotes from skilled craftsmen.");
define("_STEP_3_DESCRIPTION","<b>Compare and choose</b><br>Choose the company you like best among quotations.");
define("_STOP","Stop");
define("_SUBJECT","Subject");
define("_SUBJECT_EMPTY_ALERT","Subject cannot be empty!");
define("_SUBMIT","Submit");
define("_SUBMITTED_FOR_MODERATION","Your listing has been successfully submitted and waiting to be reviewed by a moderator!");
define("_SUBMIT_INQUIRY","Submit Inquiry");
...
define("_SUB_LOCATION","Sub Location");
define("_SUB_LOCATIONS","Sub Locations");
...
define("_UP","Up");
define("_UPDATED_FOR_MODERATION","Your listing has been updated and waiting to be reviewed by a moderator!");
...
define("_VIA_EMAIL","Via email");
define("_VIDEO","Video");
define("_VIEW","View");
define("_VIEW_LISTINGS","View Listings");
...
define("_WHAT_DO_YOU_NEED","What do you need help with?");
define("_WHAT_IS_CVV","What is CVV");
define("_WHOLE_SITE","Whole site");
define("_WITH_IMAGES_ONLY","With images only");
